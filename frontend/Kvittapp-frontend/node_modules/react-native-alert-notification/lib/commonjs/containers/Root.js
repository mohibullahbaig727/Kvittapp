...
const Root = _ref => {
  ...
  if (safeAreaInsetsContext === null) {
    ...
    }, /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_.Dialog, {
      ref: _.Dialog.instance,
      isDark: isDark,
      config: dialogConfig
    }), /*#__PURE__*/React.createElement(_.Toast, {
      ref: _.Toast.instance,
      isDark: isDark,
      config: toastConfig
    }), children)));
  }
